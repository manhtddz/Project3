...
namespace E_Project_3_API.Controllers
{
    ...
    public class ShowtimesController : ControllerBase
    {
        ...
        [HttpGet("{movieId}/{dateId}")]
        public IActionResult GetShowtimesByMovieAndDate(int movieId, int dateId)
        {
            var response = _showtimeService.GetShowtimesByMovieAndDate(movieId, dateId);
            return Ok(response);
        }
    }
}
